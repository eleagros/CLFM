...
#
# Modifications by Romy Gros, 2025:
# - Added saving of matched points to 'points_matched.pickle'
#
...
def main(argv) -> None:
  ...
  with open('./points_matched.pickle', 'wb') as handle:
    pickle.dump([match_kp0, match_kp1], handle, protocol=pickle.HIGHEST_PROTOCOL)
