...
**Important**: This repository requires **Python 3.9.** or **Python 3.8**. Using any newer version may cause compatibility issues with the dependencies.
...
2. **Install CLFM and required dependencies:**
...
*Journal of Biomedical Optics*, 30(9), 2025.  
https://doi.org/10.1117/1.JBO.30.9.096003
